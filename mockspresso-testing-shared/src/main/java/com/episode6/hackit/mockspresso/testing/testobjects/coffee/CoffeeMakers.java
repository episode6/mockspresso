...
public class CoffeeMakers {
  ...
  /**
   * The most basic coffee maker, can be created via the SimpleInjectMockspressoPlugin
   */
   ...
   * This provider can be handled automatically via the JavaxInjectMockspressoPlugin.
   */
